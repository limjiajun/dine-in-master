...
<a href = "waiter_complete.php?order_id=<?php echo $order_id; ?>" class='btn btn-primary' onclick=' return confirm("Are you sure you want to complete this order? \n Order ID = <?php echo $order_id; ?>")'>Complete Order</a>
  <a href="waiterpage.php" class='btn btn-dark'> Back </a>
  </form>
  </div></div>";
