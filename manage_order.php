  ...
  <form>
    ...
    if ($number_of_results > 0) {
        ...
        foreach ($row as $test) {
            ...
            <td ><a href = "view_order.php?order_id=<?php echo $order_id; ?>" class='btn btn-outline-primary btn-sm'>View Details</a></td>
            <td ><a href = "delete_order.php?order_id=<?php echo $order_id; ?>" class='btn btn-outline-danger'onclick=' return confirm("Are you sure you want to delete this order? \n Order ID = <?php echo $order_id; ?>")'>Delete</a></td>
...
<br>
    ...
    for ($page = 1; $page <= $number_of_page; $page++) {
        echo '<a href = "manage_order.php?pageno=' . $page . '" style=
...
<div id = "disp_btn">
    <a href = "manage_order.php" class="btn btn-secondary">Display All</a>
</div>
