...
// View Details
    ...
    <strong><p style='text-align: center;'>Table No.: "; echo $tbl_no; echo "</p></strong>;
...
?>
  ...
  <a href = "kitchen_complete.php?order_id=<?php echo $order_id; ?>&tbl_no=<?php echo $tbl_no; ?>" class='btn btn-primary' onclick=' return confirm("Are you sure you want to complete this order? \n Order ID = <?php echo $order_id; ?>")'>Complete Order</a>
  <a href="kitchenpage.php" class='btn btn-dark'> Back </a>
  </form>
  </div></div>";
