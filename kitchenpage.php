...
<!-- Display list -->
  ...
  <form>
    <div>
    <p style="text-align:left">Kitchen Crew Site</p>
    ...
    if ($number_of_results > 0) {
        ...
        foreach ($row as $test) {
            ...
            <td ><a href = "kitchen_view_order.php?order_id=<?php echo $order_id; ?>&tbl_no=<?php echo $tbl_no; ?>" class='btn btn-outline-primary btn-sm'>View Details</a></td>
            <td ><a href = "kitchen_complete.php?order_id=<?php echo $order_id; ?>&tbl_no=<?php echo $tbl_no; ?>" class='btn btn-outline-danger btn-sm'onclick=' return confirm("Are you sure you want to complete this order? \n Order ID = <?php echo $order_id; ?>")'>Complete Order</a></td>
            ...
            window.location.href="kitchenpage.php"
            </script>';
        }
    ?>
...
<br>
    ...
    for ($page = 1; $page <= $number_of_page; $page++) {
        echo '<a href = "kitchenpage.php?pageno=' . $page . '" style=
...
<div id = "disp_btn">
    <a href = "kitchenpage.php" class="btn btn-secondary">Display All</a>
</div>
